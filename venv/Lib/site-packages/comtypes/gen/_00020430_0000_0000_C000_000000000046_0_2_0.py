...
IFontDisp = Font
__all__ = [ 'IPictureDisp', 'OLE_ENABLEDEFAULTBOOL', 'FONTUNDERSCORE',
           'Picture', 'Checked', 'StdFont', 'Color',
           'OLE_XPOS_CONTAINER', 'FONTNAME', 'OLE_HANDLE',
           'Monochrome', 'IFont', 'FONTITALIC', 'IFontDisp',
           'OLE_CANCELBOOL', 'OLE_YPOS_HIMETRIC',
           ...
           'Unchecked', 'FontEvents', 'OLE_YSIZE_HIMETRIC',
           'FONTBOLD', 'OLE_XSIZE_PIXELS', 'OLE_XSIZE_CONTAINER',
           'OLE_XPOS_HIMETRIC', 'OLE_TRISTATE', 'FONTSIZE', 'Font',
           'OLE_YSIZE_CONTAINER', 'OLE_OPTEXCLUSIVE', 'OLE_COLOR',
           'IFontEventsDisp', 'Gray', 'Default', 'OLE_XPOS_PIXELS']
